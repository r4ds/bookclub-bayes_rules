...
```
```{r 18-climb_model_save, eval = FALSE, include = FALSE}
# Run this manually if you change the model.
saveRDS(climb_model, "data/ch18/climb_model.rds", compress = "xz")
saveRDS(prior_summary(climb_model), "data/ch18/climb_models_prior_summary.rds")
```

```{r 18-load_climb_model, include = FALSE}
climb_model <- readRDS("data/ch18/climb_model.rds")
```
