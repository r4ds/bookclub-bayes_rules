...
The only hard part was using an equation from chapter5: 
...
- Build a simple Bayesian Normal regression with response and predictor quantitative 

- We moved from global mean to local mean with the help of linear dependence
