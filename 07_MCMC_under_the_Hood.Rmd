...
![](images/uniform_model_andpropt.png)
...
`r knitr::include_url("https://www.youtube.com/embed/CCpL8IpUTEE")`

<details>
<summary> Meeting chat log </summary>

```
00:24:45	Gabby Palomo:	https://stats.stackexchange.com/questions/513661/example-where-the-posterior-from-jags-and-stan-are-really-different-and-have-rea
```
</details>
...
`r knitr::include_url("https://www.youtube.com/embed/Fyqm15nQ8cY")`
