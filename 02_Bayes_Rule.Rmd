...
This is a **conditional probability**. Conditional probability helps us know if B gives us an insight in A. If it does not provide any information, it means that events A and B are **independent** ($P(A|B) = P(A)$). 
